...
axios.post('https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/').then(function (response) {
  console.log("App ID: ".concat(response.data));
...
/******/ })()
;
//# sourceMappingURL=bundled317824d19cf6ac7eaca.js.map